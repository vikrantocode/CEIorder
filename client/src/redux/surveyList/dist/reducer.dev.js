...
var _default = function _default() {
  ...
  switch (action.type) {
    case _actions.SURVEY_LIST_GET_LIST:
      return _objectSpread({}, state, {
        loading: false
      });

    case _actions.SURVEY_LIST_GET_LIST_SUCCESS:
      return _objectSpread({}, state, {
        loading: true,
    ...
    case _actions.SURVEY_LIST_GET_LIST_ERROR:
      return _objectSpread({}, state, {
        loading: true,
        error: action.payload
      });

    case _actions.SURVEY_LIST_GET_LIST_WITH_FILTER:
      ...
      var filteredItems = state.allSurveyItems.filter(function (item) {
    ...
    case _actions.SURVEY_LIST_GET_LIST_WITH_ORDER:
      if (action.payload === '') {
        return _objectSpread({}, state, {
          loading: true,
      ...
      var sortedItems = state.surveyItems.sort(function (a, b) {
    ...
    case _actions.SURVEY_LIST_GET_LIST_SEARCH:
      if (action.payload === '') {
        return _objectSpread({}, state, {
          surveyItems: state.allSurveyItems
        });
      ...
      var searchItems = state.allSurveyItems.filter(function (item) {
    ...
    case _actions.SURVEY_LIST_ADD_ITEM:
      return _objectSpread({}, state, {
        loading: false
      });

    case _actions.SURVEY_LIST_ADD_ITEM_SUCCESS:
      return _objectSpread({}, state, {
        loading: true,
        allSurveyItems: action.payload,
        surveyItems: action.payload
    ...
    case _actions.SURVEY_LIST_ADD_ITEM_ERROR:
      return _objectSpread({}, state, {
        loading: true,
        error: action.payload
      });

    case _actions.SURVEY_LIST_SELECTED_ITEMS_CHANGE:
      return _objectSpread({}, state, {
        loading: true,
