...
exports.centerTextPlugin = exports.chartTooltip = void 0;

var _ThemeColors = require("../../helpers/ThemeColors");

var chartTooltip = {
  backgroundColor: (0, _ThemeColors.ThemeColors)().foregroundColor,
  titleFontColor: (0, _ThemeColors.ThemeColors)().primaryColor,
  borderColor: (0, _ThemeColors.ThemeColors)().separatorColor,
  borderWidth: 0.5,
  bodyFontColor: (0, _ThemeColors.ThemeColors)().primaryColor,
  bodySpacing: 10,
  xPadding: 15,
  yPadding: 15,
  cornerRadius: 0.15
...
var centerTextPlugin = {
  ...
  beforeDraw: function beforeDraw(chart) {
    ...
    ctx.fillStyle = (0, _ThemeColors.ThemeColors)().primaryColor;
...
exports.centerTextPlugin = centerTextPlugin;