...
const userData = jwtdecode(localStorage.getItem('auth-token'));
      ...
      // },
      {
        ...
        subs: [
          ...
          },
          {
            ...
            label: 'Categories',
            to: `${adminRoot}/inventory/categories`,
          },
          {
            icon: 'iconsminds-shop-3',
            label: 'Vendors',
            to: `${adminRoot}/inventory/vendors`,
          },
          {
            icon: 'simple-icon-tag',
            label: 'Brands',
            to: `${adminRoot}/inventory/brands`,
          },
          {
          ...
          },
          {
            ...
            label: 'Product Types',
            to: `${adminRoot}/inventory/product-types`,
          },
          {
            icon: 'simple-icon-share',
            label: 'Product Groups',
            to: `${adminRoot}/inventory/product-groups`,
          },
          {
            icon: 'iconsminds-duplicate-layer',
            label: 'Archive Products',
            to: `${adminRoot}/inventory/archive-products`,
          },
        ],
      },
      {
        ...
        subs: [
          {
            icon: 'simple-icon-people',
            label: 'Customers',
            to: `${adminRoot}/customers/customers`,
          },
        ],
      },
      {
        ...
        subs: [
          ...
          {
            icon: 'iconsminds-notepad',
            label: 'Import Bulk Order',
            to: `${adminRoot}/orders/import-bulk-order`,
          },
          {
            icon: 'iconsminds-notepad',
            label: 'Import Bulk Orders',
            to: `${adminRoot}/orders/import-bulk-orders`,
          },
          {
            icon: 'iconsminds-shop-2',
            label: 'Warehouses',
            to: `${adminRoot}/orders/warehouses`,
          },
        ],
      },
      // {
